...
export function LegalPanel({ draft, edits, onSelect }: PanelProps) {
  return (
    <div className="flex flex-col gap-[9px]">
      <TextAreaField label={t('inspector.legal.footer', 'Legal footer')} labelClassName="mb-[9px]" rows={7} value={draft.body.legalText} onFocus={edits.beginEdit} onChange={(value) => edits.set('legalText', value)} testId="invoices-legal" />

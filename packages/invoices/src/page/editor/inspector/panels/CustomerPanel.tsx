...
export function CustomerPanel({ draft, edits }: PanelProps) {
  const lines = t('inspector.customer.addressContact', 'Address & contact');
  return (
    <div className="flex flex-col gap-[9px]">
      <TextField label={t('inspector.customer.clientName', 'Client name')} labelClassName="mb-[9px]" value={draft.body.customerName} onFocus={edits.beginEdit} onChange={(value) => edits.set('customerName', value)} className="font-bold" testId="invoices-customer-name" />

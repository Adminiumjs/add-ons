...
export function PoTermsPanel({ draft, edits, onSelect }: PanelProps) {
  return (
    <div className="flex flex-col gap-[9px]">
      <TextAreaField label={t('inspector.poterms.terms', 'Purchase order terms')} labelClassName="mb-[9px]" rows={7} value={draft.body.poTerms} onFocus={edits.beginEdit} onChange={(value) => edits.set('poTerms', value)} testId="invoices-po-terms" />

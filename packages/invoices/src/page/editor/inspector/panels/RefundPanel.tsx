...
export function RefundPanel({ draft, edits, onSelect }: PanelProps) {
  return (
    <div className="flex flex-col gap-[9px]">
      <TextAreaField label={t('inspector.refund.policy', 'Refund policy')} labelClassName="mb-[9px]" rows={7} value={draft.body.refText} onFocus={edits.beginEdit} onChange={(value) => edits.set('refText', value)} testId="invoices-refund" />

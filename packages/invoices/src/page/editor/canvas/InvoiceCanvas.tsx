        ...
        <div className="mb-[30px] flex items-start justify-between gap-5">
          <Region section="branding" selected={section} onSelect={onSelect}>
            <div className="mb-[11px] flex items-center gap-[11px]">
              ...
              <InlineInput
                label={t('canvas.brandName', 'Brand name')}
                value={body.logoText}
            ...
            <div className="text-[11.5px] leading-[1.6] text-[#6b6b76]">{t('canvas.brandingHint', 'Branding · click to edit')}</div>
          </Region>
            ...
            const label =
              block.custom !== null
                ? block.custom.title.trim() === ''
                  ? t('section.custom.title', 'Custom section')
                  : block.custom.title

  ...
  return (
    ...
    >
      <button
        ...
        title={t('canvas.insertHere', 'Add a section here')}
        aria-label={t('canvas.insertAbove', 'Add a section above {label}', { label })}
        onClick={(event) => {
      ...
      >
        ...
        <span className="inline-flex shrink-0 items-center gap-[5px] rounded-[20px] bg-[var(--adm-invoice-accent-soft)] px-[9px] py-[3px] text-[10.5px] font-bold text-[var(--adm-invoice-accent)]">
          ...
          {t('canvas.addSection', 'Add section')}
        </span>
        <span className="block h-px flex-1 bg-[var(--adm-invoice-accent)] opacity-30" aria-hidden="true" />
      </button>
      <button
        ...
        draggable
        title={t('canvas.reorderSection', 'Drag to reorder section')}
        aria-label={t('canvas.reorderSectionOf', 'Drag to reorder section: {label}', { label })}

...
/*
 * `Bars` STAYED IN `barcode-labels`, where it belongs.
 *
 * This file is that package's `atoms.tsx` with one component removed: a
 * renderer for barcode modules, which drew a symbology this add-on has no
 * opinion about and imported a module that does not exist here. Copying an
 * atoms file wholesale and leaving the sibling's domain component in it is how
 * a shared-looking file stops being shareable.
 */

...
import { INSTALL_LAYOUT, type HostFacts } from '../config.ts';
 ...
 * literal `'@adminium/add-on-host'` becomes the vendored path, and a literal
 * `'../x` becomes `'../../add-ons/kit/x`. That is correct for the imports at
 ...
 * QUOTED WHOLE — `'@adminium/add-on-host'` including both quotes, and `'..`
